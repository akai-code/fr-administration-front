...
exports.LegalServiceService = void 0;
...
let LegalServiceService = class LegalServiceService {
    constructor(associationFormService) {
        this.associationFormService = associationFormService;
    }
    async validate(associationFormId) {
        return this.associationFormService.updateLegalValidation(associationFormId, true);
    }
};
LegalServiceService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [association_forms_service_1.AssociationFormsService])
], LegalServiceService);
exports.LegalServiceService = LegalServiceService;
//# sourceMappingURL=legal-service.service.js.map